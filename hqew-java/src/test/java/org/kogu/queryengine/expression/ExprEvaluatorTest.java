...
class ExprEvaluatorTest {
    ...
    void everyExpressionShapeReturnsLengthMatchingBatchRowCount() {
        ...
        List<Expr> expressions = List.of(
                ...
                new BinaryExpr(new ColumnRef("c_int"), ArithmeticOp.Add, new Literal.Int32(1)),
                new BinaryExpr(new ColumnRef("c_long"), ArithmeticOp.Subtract, new Literal.Int64(2L)),
                new BinaryExpr(new ColumnRef("c_double"), ArithmeticOp.Multiply, new Literal.Float64(1.5)),
                new BinaryExpr(new ColumnRef("c_int"), ArithmeticOp.Divide, new Literal.Int32(2)),

                // 4. BinaryExpr - Comparison
                new BinaryExpr(new ColumnRef("c_int"), ComparisonOp.EqEq, new Literal.Int32(3)),
                new BinaryExpr(new ColumnRef("c_long"), ComparisonOp.NEq, new Literal.Int64(20L)),
                new BinaryExpr(new ColumnRef("c_double"), ComparisonOp.LT, new Literal.Float64(5.0)),
                new BinaryExpr(new ColumnRef("c_utf8"), ComparisonOp.LTEq, new Literal.Str("c")),
                new BinaryExpr(new ColumnRef("c_int"), ComparisonOp.GT, new Literal.Int32(5)),
                new BinaryExpr(new ColumnRef("c_int"), ComparisonOp.GTEq, new Literal.Int32(0)),
                new BinaryExpr(new ColumnRef("c_bool"), ComparisonOp.EqEq, Literal.Bool.False),
