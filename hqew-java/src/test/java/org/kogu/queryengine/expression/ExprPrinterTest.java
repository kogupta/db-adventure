...
class ExprPrinterTest {
    ...
    void rendersInfixRepresentations() {
        ...
        Expr arithmetic = new BinaryExpr(new ColumnRef("a"), ArithmeticOp.Add, new Literal.Int32(1));
        assertEquals("(a + 1)", ExprPrinter.toInfix(arithmetic));

        Expr comparison = new BinaryExpr(new ColumnRef("trip_distance"), ComparisonOp.GT, new Literal.Int32(5));
